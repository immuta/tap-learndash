...
from tap_learndash.auth import LearnDashAuthenticator
...
class LearnDashStream(RESTStream):
    ...
    @property
    def authenticator(self) -> LearnDashAuthenticator:
        """Return a new authenticator object."""
        return LearnDashAuthenticator.create_for_stream(self)
